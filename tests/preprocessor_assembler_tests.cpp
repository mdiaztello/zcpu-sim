...
//ASHIFTR instruction tests
TEST(PREPROCESSOR_ASSEMBLER_TESTS, ashiftr_encodes_destination_properly)
{
    LONGS_EQUAL(0x28000000, ASHIFTR(R0, R0, R0));
    LONGS_EQUAL(0x28200000, ASHIFTR(R1, R0, R0));
    LONGS_EQUAL(0x28400000, ASHIFTR(R2, R0, R0));
    LONGS_EQUAL(0x28A00000, ASHIFTR(R5, R0, R0));
    LONGS_EQUAL(0x2A200000, ASHIFTR(R17, R0, R0));
    LONGS_EQUAL(0x2AE00000, ASHIFTR(R23, R0, R0));
    LONGS_EQUAL(0x2BE00000, ASHIFTR(R31, R0, R0));
}

TEST(PREPROCESSOR_ASSEMBLER_TESTS, ashiftr_encodes_source1_register_properly)
{
    LONGS_EQUAL(0x28000000, ASHIFTR(R0, R0, R0));
    LONGS_EQUAL(0x28010000, ASHIFTR(R0, R1, R0));
    LONGS_EQUAL(0x28020000, ASHIFTR(R0, R2, R0));
    LONGS_EQUAL(0x28050000, ASHIFTR(R0, R5, R0));
    LONGS_EQUAL(0x28110000, ASHIFTR(R0, R17, R0));
    LONGS_EQUAL(0x28170000, ASHIFTR(R0, R23, R0));
    LONGS_EQUAL(0x281F0000, ASHIFTR(R0, R31, R0));
}

TEST(PREPROCESSOR_ASSEMBLER_TESTS, ashiftr_encodes_source2_register_properly)
{
    LONGS_EQUAL(0x28000000, ASHIFTR(R0, R0, R0));
    LONGS_EQUAL(0x28000800, ASHIFTR(R0, R0, R1));
    LONGS_EQUAL(0x28001000, ASHIFTR(R0, R0, R2));
    LONGS_EQUAL(0x28002800, ASHIFTR(R0, R0, R5));
    LONGS_EQUAL(0x28008800, ASHIFTR(R0, R0, R17));
    LONGS_EQUAL(0x2800B800, ASHIFTR(R0, R0, R23));
    LONGS_EQUAL(0x2800F800, ASHIFTR(R0, R0, R31));
}
