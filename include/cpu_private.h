...
struct cpu
{
    ...
    uint32_t* trap_vector_register; //This register holds the interrupt vector number for
                                    //software interrupts (i.e. it tells us where to jump
                                    //to when we get an SWI instruction)
